...
Delta_VTV{1}(Loop,:) = [0, 0, 0]; Delta_VTV{2}(Loop,:) = [0, 0, 0]; Delta_VTV{3}(Loop,:) = [0, 0, 0]; Delta_VTV{4}(Loop,:) = [0, 0, 0]; Delta_VTV{5}(Loop,:) = [1+sin(pi/2*T/15+3*pi/2), 1+sin(pi/2*T/15+3*pi/2), 0.1*pi+0.1*pi*sin(pi/2*T/15+3*pi/2)];
